...
<head>
    ...
    <script type="text/javascript" src="./theme/lib/fancybox-2.1/source/jquery.fancybox.pack.js?v=2.1.5"></script>
    ...
    <script src="./theme/home.js"></script>
...
<body data-spy="scroll" data-target=".navbar" data-offset="150">
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-none fixed-top">
        <a class="navbar-brand" href="file:///F:/PTIT/Web/B%C3%A0i%201/app/index.html" style="margin-bottom: -4px;"><img
                class="w-100 h-100" src="./img/logo.png" alt="" srcset=""></a>
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav mr-auto">
                <li id="toTrending" class="nav-item">
                    <a class="nav-link text-uppercase" href="#trending"><small>Trang chủ</small></a>
                </li>
                <li id="toJustReleased" class="nav-item">
                    <a class="nav-link text-uppercase" href="#justReleased"><small>Mới nhất</small></a>
                </li>
                <li id="toCategory" class="nav-item">
                    <a class="nav-link text-uppercase" href="#category"><small>Thể loại</small></a>
                </li>
                <li id="toPopularWriter" class="nav-item">
                    <a class="nav-link text-uppercase" href="#popularWriter"><small>Tác giả</small></a>
                </li>
                <li id="toFooter" class="nav-item">
                    <a class="nav-link text-uppercase" href="#footer"><small>Liên hệ</small></a>
                </li>
            </ul>
            ...
            <ul class="navbar-nav">
                <li class="nav-item dropdown" title="Tài khoản">
                    <a href="#" class="dropdown-toggle nav-link ml-3" data-toggle="dropdown">
                    ...
                    <ul class="dropdown-menu" style="min-width: 6rem">
                        <li><a href="#" class="text-dark pl-2 pr-2"><small>Đăng xuất</small></a></li>
                        <li><a href="#" class="text-dark pl-2 pr-2"><small>Đăng nhập</small></a></li>
                    </ul>
                </li>
                <li class="nav-item" title="Giỏ hàng">
                    <a class="nav-link ml-3" href="cart.php" target="_blank">
                        <i class="fas fa-shopping-cart fa-2x"></i>
                        <!-- Số lượng vật phẩm trong giỏ -->
                        <span
                            class="badge position-absolute badge-pill badge-danger <?php echo ($items>0) ? '' : 'd-none'?>"
                            id="itemInCart"><?php echo $items ?>
                        </span>
