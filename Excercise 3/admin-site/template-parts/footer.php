<footer class="footer">
    <div class="container-fluid">
        <nav class="float-left">
            <ul>
                <li>
                    <a href="http://localhost/brazosbookstore/">
                        Trang chủ
                    </a>
                </li>
                <li>
                    <a href="http://localhost/brazosbookstore/#trending">
                        Giới thiệu
                    </a>
                </li>
                <li>
                    <a href="http://localhost/brazosbookstore/#popularWriter">
                        Tác giả
                    </a>
                </li>
                <li>
                    <a href="http://localhost/brazosbookstore/#footer">
                        Liên hệ
                    </a>
                </li>
            </ul>
        ...
        <div class="copyright float-right">
            ...
            <a href="http://localhost/brazosbookstore/" target="_blank">Brazos Bookstore</a> tiệm sách quốc dân.
        </div>
    </div>
</footer>
</div>
...
<!-- HACK: Khi nào muốn dùng thì lắp key vào -->
<!--  Google Maps Plugin    -->
